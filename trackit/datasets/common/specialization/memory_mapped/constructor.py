...
from trackit.datasets.base.common.utils.bounding_box import get_bounding_box, get_bounding_box_v, get_bounding_box_i
...
def memory_mapped_constructor_get_bounding_box_mm(base_object: dict):
    object_bounding_box_v, object_bounding_box_validity_flag_v = get_bounding_box_v(base_object)
    object_bounding_box_i, object_bounding_box_validity_flag_i = get_bounding_box_i(base_object)
    return object_bounding_box_v, object_bounding_box_validity_flag_v, object_bounding_box_i, object_bounding_box_validity_flag_i
