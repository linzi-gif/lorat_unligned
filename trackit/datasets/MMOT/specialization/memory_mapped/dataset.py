...
__all__ = ['MultiModalObjectTrackingDataset_MemoryMapped']
__version__ = 4


class MultiModalObjectTrackingDatasetFrame_MemoryMapped:
...
class MultiModalObjectTrackingDatasetSequence_MemoryMapped:
    def __init__(self, root_path: str, sequence_attributes: dict,
    ...
    def __getitem__(self, index: int):
        ...
        bounding_box_validity_flag = self.bounding_box_validity_flag_vector[
            index] if self.bounding_box_validity_flag_vector is not None else None

        return MultiModalObjectTrackingDatasetFrame_MemoryMapped(self.root_path,
...
class MultiModalObjectTrackingDataset_MemoryMapped(MemoryMappedDataset):
    def __init__(self, root_path: str, storage: ListMemoryMapped):
        super(MultiModalObjectTrackingDataset_MemoryMapped, self).__init__(root_path, storage, __version__,
                                                                           'MultiModalObjectTracking')

    @staticmethod
    def load(root_path: str, path: str):
        return MultiModalObjectTrackingDataset_MemoryMapped(root_path, MemoryMappedDataset._load_storage(path))
    ...
    def __getitem__(self, index: int):
        ...
        return MultiModalObjectTrackingDatasetSequence_MemoryMapped(self.root_path,
