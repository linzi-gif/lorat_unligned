...
import trackit.datasets.MMOT.specialization.memory_mapped.dataset as UAMMOT_dataset
...
def construct_multi_modal_object_tracking_dataset_memory_mapped_from_base_video_dataset(base_dataset: dict, path: str):
    constructor, dataset_bounding_box_data_type = memory_mapped_constructor_common_preliminary_works(base_dataset,
                                                                                                     'video', path,
                                                                                                     UAMMOT_dataset.__version__,
