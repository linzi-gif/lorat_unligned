...
from trackit.datasets.base.common.utils.bounding_box import get_bounding_box_v, get_bounding_box_i, set_bounding_box_v_, set_bounding_box_i_
...
class UnalignedDatasetObjectManipulator:
    def __init__(self, image: dict, index_of_object: int, parent_iterator=None):
        self.object_ = image['objects'][index_of_object]
        self.parent_image = image
        self.index_of_object = index_of_object
    ...
    def get_bounding_box_v(self):
        return get_bounding_box_v(self.object_)
    
    def get_bounding_box_i(self):
        return get_bounding_box_i(self.object_)
    
    def set_bounding_box(self, bounding_box_v, bounding_box_i, validity=None):
        set_bounding_box_v_(self.object_, bounding_box_v, validity)
        set_bounding_box_i_(self.object_, bounding_box_i, validity)

    def bounding_box_mark_validity(self, value: bool):
        self.object_['bounding_box_v']['validity'] = value
        self.object_['bounding_box_i']['validity'] = value

    def delete_bounding_box(self):
        del self.object_['bounding_box_v']
        del self.object_['bounding_box_i']
    ...
    def has_bounding_box(self):
        return 'bounding_box_v' in self.object_ and 'bounding_box_i' in self.object_
...
class UnalignedDatasetObjectManipulatorIterator:
    def __init__(self, frame: dict):
        self.frame = frame
        self.index = 0
    ...
    def __next__(self):
        ...
        modifier = UnalignedDatasetObjectManipulator(self.frame, self.index, self)
        self.index += 1
        return modifier
