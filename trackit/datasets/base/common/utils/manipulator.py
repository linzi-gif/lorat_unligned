...
def fit_objects_bounding_box_in_image_size_unaligned(frame, context, exclude_non_validity=True):
    image_size_v = frame.get_image_size_v()
    image_size_i = frame.get_image_size_i()
    for object_ in frame:
        if object_.has_bounding_box():
            ...
            if exclude_non_validity:
                if bounding_box_validity_v == False or bounding_box_validity_i == False:
                    continue
            bounding_box_v = bounding_box_fit_in_image_boundary(bounding_box_v, image_size_v,
                                                              context.get_bounding_box_format(),
                                                              context.get_bounding_box_coordinate_system())
            bounding_box_i = bounding_box_fit_in_image_boundary(bounding_box_i, image_size_i,
                                                              context.get_bounding_box_format(),
                                                              context.get_bounding_box_coordinate_system())
...
def update_objects_bounding_box_validity_unaligned(frame, context, skip_if_mark_non_validity=True):
    image_size_v = frame.get_image_size_v()
    image_size_i = frame.get_image_size_i()
    for object_ in frame:
        if object_.has_bounding_box():
            ...
            if skip_if_mark_non_validity:
                if bounding_box_validity_v == False or bounding_box_validity_i == False:
                    continue
            bounding_box_validity_v = bounding_box_is_intersect_with_image(bounding_box_v, image_size_v,
                                                                         context.get_bounding_box_format(),
                                                                         context.get_bounding_box_coordinate_system())
            bounding_box_validity_i = bounding_box_is_intersect_with_image(bounding_box_i, image_size_i,
                                                                         context.get_bounding_box_format(),
                                                                         context.get_bounding_box_coordinate_system())
            object_.set_bounding_box(bounding_box_v, bounding_box_i, bounding_box_validity_v and bounding_box_validity_i)
