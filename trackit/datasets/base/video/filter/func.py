...
from .tweak_tool import VideoDatasetTweakTool, UAMMVideoDatasetTweakTool
...
def apply_filters_on_video_dataset_unaligned_(dataset: dict, filters: list):
    if len(filters) == 0:
        return dataset
    ...
    dataset_tweak_tool = UAMMVideoDatasetTweakTool(dataset)
