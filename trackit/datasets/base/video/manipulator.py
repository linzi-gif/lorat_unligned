from trackit.datasets.base.common.manipulator import _BaseDatasetManipulator, DatasetObjectManipulatorIterator, UnalignedDatasetObjectManipulatorIterator
...
class VideoDatasetFrameManipulator:
    ...
    def __iter__(self):
        return UnalignedDatasetObjectManipulatorIterator(self.frame)
