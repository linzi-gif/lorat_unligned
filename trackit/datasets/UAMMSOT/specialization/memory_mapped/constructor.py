...
import trackit.datasets.UAMMSOT.specialization.memory_mapped.dataset as UAMMSOT_dataset
from trackit.datasets.common.specialization.memory_mapped.constructor import memory_mapped_constructor_common_preliminary_works, \
    memory_mapped_constructor_commit_data, memory_mapped_constructor_get_bounding_box_mm, \
...
def construct_unalgined_multi_modal_object_tracking_dataset_memory_mapped_from_base_video_dataset(base_dataset: dict, path: str):
    constructor, dataset_bounding_box_data_type = memory_mapped_constructor_common_preliminary_works(base_dataset,
                                                                                                     'video', path,
                                                                                                     UAMMSOT_dataset.__version__,
    ...
    for base_sequence in base_dataset['sequences']:
        ...
        sequence_bounding_box_matrix_v = []
        sequence_bounding_box_validity_flag_vector_v = []

        sequence_bounding_box_matrix_i = []
        sequence_bounding_box_validity_flag_vector_i = []

        sequence_frame_sizes_v = []
        sequence_frame_sizes_i = []
        ...
        for index_of_base_frame, base_frame in enumerate(base_sequence['frames']):
            ...
            sequence_frame_sizes_v.append(first_frame_size[0])
            sequence_frame_sizes_i.append(first_frame_size[1])
            base_object = None
            ...
            frame_bounding_box_v = None
            frame_bounding_box_validity_v = None

            frame_bounding_box_i = None
            frame_bounding_box_validity_i = None
            ...
            if base_object is not None:
                ...
                if 'bounding_box_v' in base_object and 'bounding_box_i' in base_object:
                    frame_bounding_box_v, frame_bounding_box_validity_v, frame_bounding_box_i, frame_bounding_box_validity_i = memory_mapped_constructor_get_bounding_box_mm(
                        base_object)

            sequence_bounding_box_matrix_v.append(frame_bounding_box_v)
            sequence_bounding_box_validity_flag_vector_v.append(frame_bounding_box_validity_v)
            sequence_bounding_box_matrix_i.append(frame_bounding_box_i)
            sequence_bounding_box_validity_flag_vector_i.append(frame_bounding_box_validity_i)
        ...
        if sequence_frame_size_all_equal:
            sequence_attributes['frame_size_v'] = np.asarray(first_frame_size[0])
            sequence_attributes['frame_size_i'] = np.asarray(first_frame_size[1])
            sequence_frame_sizes_v = None
            sequence_frame_sizes_i = None
        else:
            sequence_frame_sizes_v = np.asarray(sequence_frame_sizes_v)
            sequence_frame_sizes_i = np.asarray(sequence_frame_sizes_i)

        sequence_attributes['frames'] = frame_attributes_list

        sequence_bounding_box_matrix_v, additional_sequence_bounding_box_validity_flag_vector_v = memory_mapped_constructor_generate_bounding_box_matrix(
            sequence_bounding_box_matrix_v, dataset_bounding_box_data_type)
        sequence_bounding_box_matrix_i, additional_sequence_bounding_box_validity_flag_vector_i = memory_mapped_constructor_generate_bounding_box_matrix(
            sequence_bounding_box_matrix_i, dataset_bounding_box_data_type)
        
        sequence_bounding_box_validity_flag_vector_v = memory_mapped_constructor_generate_bounding_box_validity_flag_vector(
            sequence_bounding_box_validity_flag_vector_v, additional_sequence_bounding_box_validity_flag_vector_v)
        sequence_bounding_box_validity_flag_vector_i = memory_mapped_constructor_generate_bounding_box_validity_flag_vector(
            sequence_bounding_box_validity_flag_vector_i, additional_sequence_bounding_box_validity_flag_vector_i)
        ...
        sequences_list.append((sequence_attributes, sequence_frame_sizes_v, sequence_frame_sizes_i, 
                               sequence_bounding_box_matrix_v, sequence_bounding_box_matrix_i,
                               sequence_bounding_box_validity_flag_vector_v, sequence_bounding_box_validity_flag_vector_i, 
                               optional_sequence_attributes))
