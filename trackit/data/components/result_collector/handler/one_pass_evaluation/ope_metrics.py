...
_bin_index_precision_score_5 = 5
_bin_index_normalized_precision_score_5 = 5
...
class OPEMetrics:
    ...
    @property
    def precision_score_5(self) -> float:
        return self.precision_curve[_bin_index_precision_score_5].item()
    ...
    @property
    def normalized_precision_score_5(self) -> float:
        return self.normalized_precision_curve[_bin_index_normalized_precision_score_5].item()
...
class DatasetOPEMetricsList:
    ...
    def get_precision_score_5(self) -> np.ndarray:
        return self.precision_curve[:, _bin_index_precision_score_5]
    ...
    def get_normalized_precision_score_5(self) -> np.ndarray:
        return self.normalized_precision_curve[:, _bin_index_normalized_precision_score_5]
